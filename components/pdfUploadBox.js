import styles from './pdfUploadBox.module.css';
...
function PDFUpload(props) {
    ...
    return (
        <div className={styles.container}>
            <label className={styles.header} for="file">
            ...
            <input className={styles.file} id="file" type="file" accept=".pdf" onChange={props.handlePdfUpload} />
